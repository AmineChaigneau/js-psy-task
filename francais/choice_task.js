function choice_task(practice, numPrac, numBlocks, numTrials) {
    ...
    if (practice != 0) {
        for(var i = 0; i < numPrac; i++) {
            ...
            var pract_trial = {
                type: 'button-choice',
                prompt: "<p style='font-size: 2em; margin-top: -50px'>" + trial.stimulus + "</p> <p style='font-size: 0.8em; line-height: 1em;'>Veuillez cliquer sur le button de gauche ou le boutton de droite afin de sélectionner une réponse</p>",
